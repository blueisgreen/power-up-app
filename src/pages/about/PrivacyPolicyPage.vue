<template>
  <div class="article">
    <h1 class="headline">Privacy Policy for Power Up Magazine</h1>

    <p>
      At Power Up Magazine, accessible from https://www.powerupmagazine.com, one
      ...
      Power Up Magazine and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Power Up Magazine. This policy is not applicable to any
    ...
    <h2 class="headline">Information we collect</h2>
    ...
    <h2 class="headline">Log Files</h2>

    <p>
      Power Up Magazine follows a standard procedure of using log files. These
    ...
    <h2 class="headline">Cookies and Web Beacons</h2>

    <p>
      Like any other website, Power Up Magazine uses 'cookies'. These cookies
    ...
    <h2 class="headline">Advertising Partners Privacy Policies</h2>

    <p>Power Up Magazine does not use advertising partners.</p>

    <h2 class="headline">Third Party Privacy Policies</h2>

    <p>
      Power Up Magazine's Privacy Policy does not apply to other advertisers or
    ...
    <h2 class="headline">GDPR Data Protection Rights</h2>
    ...
    <h2 class="headline">Children's Information</h2>
    ...
    <p>
      Power Up Magazine does not knowingly collect any Personal Identifiable
