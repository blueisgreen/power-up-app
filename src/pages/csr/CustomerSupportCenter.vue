        ...
        <q-item clickable>
          ...
          <q-item-section>
            <q-item-label lines="3"
              >If the birds and the bees are as smart as the tree, what color
              are the dandilions in the springtime under a full moon? Also, what
              is your favorite color? Lorem ipsum dolor sit amet, consectetur
              ...
              deserunt mollit anim id est laborum.</q-item-label
            >
          </q-item-section>
        </q-item>
      </q-list>
